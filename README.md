# Dropbox SDK for Go [UNOFFICIAL] [![GoDoc](https://godoc.org/github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox?status.svg)](https://godoc.org/github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox) [![Build Status](https://travis-ci.org/dropbox/dropbox-sdk-go-unofficial.svg?branch=master)](https://travis-ci.org/dropbox/dropbox-sdk-go-unofficial) [![Go Report Card](https://goreportcard.com/badge/github.com/MLCSteve/dropbox-sdk-go-unofficial)](https://goreportcard.com/report/github.com/MLCSteve/dropbox-sdk-go-unofficial)
...
### Uh OK, so why are you releasing this?
  ...
  * the SDK, while unofficial, _is_ usable. See [dbxcli](https://github.com/MLCSteve/dbxcli) for an example application built using the SDK
...
```sh
$ go get github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox/...
```
...
* `github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox/team`
* `github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox/users`

Additionally, the base `github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox` package exports some configuration and helper methods.
...
```go
import "github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox"
import "github.com/MLCSteve/dropbox-sdk-go-unofficial/dropbox/users"
...
This SDK is automatically generated using the public [Dropbox API spec](https://github.com/MLCSteve/dropbox-api-spec) and [Stone](https://github.com/MLCSteve/stone). See this [README](https://github.com/MLCSteve/dropbox-sdk-go-unofficial/blob/master/generator/README.md)
